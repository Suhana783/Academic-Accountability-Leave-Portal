...
import { login, getMe, logout, createStudent, createAdmin, removeUser, removeUserByEmail, getAllStudents, getAllAdmins } from '../controllers/authController.js'
...
router.delete('/remove-user-by-email', protect, restrictTo('admin'), removeUserByEmail)
